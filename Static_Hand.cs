...
public class Static_Hand : MonoBehaviour {
   ...
   MixedRealityPose virtualHand;
    ...
    void Start() {
      ...
      Wrist.transform.parent = parent2.transform;
        ...
        //Grab Initial Scale of either one of the parents
        initialScale = parent.transform.localScale.x;
    }
   ...
   void Scaling() {
      ...
      if (scaleControl) {
            ...
            dCurr1 = Vector3.Distance(parent.transform.position, Camera.main.transform.position);
